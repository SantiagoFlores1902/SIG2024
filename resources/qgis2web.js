...
map.getView().fit([-7286933.456837, -3136112.641397, -7274311.982084, -3126319.026287], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis de zonas inundables en Famaillá</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Datosdelazona_1,
    colName: 'Riesgo de Inundación',
    zoom: 10,
    collapsed: true,
    map: map
});
